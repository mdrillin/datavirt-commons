 ...
 */
package org.jboss.datavirt.commons.dev.server.discovery;

import java.io.File;
import java.io.IOException;

import org.jboss.datavirt.commons.dev.server.DevServerModule;
...
public class WebAppModuleFromMavenDiscoveryStrategy extends AbstractModuleDiscoveryStrategy {
    ...
    /**
     * @see org.jboss.datavirt.commons.dev.server.discovery.IModuleDiscoveryStrategy#getName()
     */
    @Override
    ...
    /**
     * @see org.jboss.datavirt.commons.dev.server.discovery.IModuleDiscoveryStrategy#discover(org.jboss.datavirt.commons.dev.server.discovery.ModuleDiscoveryContext)
     */
    @Override
    public DevServerModule discover(ModuleDiscoveryContext context) {
        ...
        if (path.contains("-classes.jar") && path.startsWith("file:")) {
            ...
            if (war.isFile()) {
                ...
                workDir.mkdirs();
                try {
                    org.jboss.datavirt.commons.dev.server.util.ArchiveUtils.unpackToWorkDir(war, workDir);
                } catch (IOException e) {
